...
use crate::infer::unify_key::{ConstVidKey, CtorVidKey, RegionVidKey};
...
pub(crate) enum UndoLog<'tcx> {
    ...
    CtorUnificationTable(sv::UndoLog<ut::Delegate<CtorVidKey<'tcx>>>),
...
impl<'tcx> Rollback<UndoLog<'tcx>> for InferCtxtInner<'tcx> {
    fn reverse(&mut self, undo: UndoLog<'tcx>) {
        match undo {
            ...
            UndoLog::CtorUnificationTable(undo) => self.ctor_unification_storage.reverse(undo),
